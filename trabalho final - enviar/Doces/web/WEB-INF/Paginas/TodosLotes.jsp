<%-- 
    Document   : TodosLotes
    Created on : 20/06/2017, 19:41:15
    Author     : Aluno
--%>

<%@page import="Dao.DocesDao"%>
<%@page import="Beans.Doces"%>
...
<div class="banner">
  ...
  <div class="banner-inner container">
    <h1 class="banner-lead">
      <span class="banner-lead-1">Listar Lotes</span>
    </h1>
   
    <div class="banner-buttons">
        <font color="#FFF">
             <%
            Collection<Lote> jg = (Collection<Lote>) request.getAttribute("lote");
            //pegar o nome do doce
            for(Lote jgs : jg){
                Doces dc = new Doces();
                dc = new DocesDao().buscaID(String.valueOf(jgs.getId_lote()));
                out.println("<li> Doce: "+dc.getNome()+ " - Quantidade: " + jgs.getQuantidade()+ " - Preço: " + jgs.getValor_lote()+"</li><br>");
            }
        %>
            </font>
