...
<%-- 
    Document   : CadastrarDoce
    Created on : 20/06/2017, 19:45:15
    Author     : Aluno
--%>
...
<div class="banner">
    ...
    <div class="header-inner container clear">
      ...
      <div class="navigation">
        <ul class="navigation-menu">
          <li class="navigation-item"><a href="#about">Home</a></li>
  ...
  <div class="banner-inner container">
    <h1 class="banner-lead">
      <span class="banner-lead-1">Cadastrar Lote</span>
    </h1>
    ...
    <div class="banner-buttons">
        <form action="Controller" method="POST">
            <font color="#FFF">
             <form action="Controller" method="POST">
            <p>Doce: <input type="text" name="doce"></p>
            <p>Quantidade <input type="text" name="quantidade"></p>
            <p>Valor: <input type="text" name="valor"></p>
            <p><input type="submit" value="Fazer cadastro!"></p>
            <input type="hidden" name="tarefa" value="CadastroLote">
        </form>
        
        <form action="Controller" method="POST">
            <p>Qual lote Foi vendido: <input type="text" name="lote"></p>
            <p><input type="submit" value="Apagar Lote!"></p>
            <input type="hidden" name="tarefa" value="ApagarLote">
        </form>
            </font>
